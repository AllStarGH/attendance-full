...
public class Swagger2 {
	 ...
	 * 可以获取属性文件中对应的值（如果属性文件中没有这个属性，则会报错。可以通过赋予默认值解决这个问题
	 */
	@Value("${swagger.basePackage:com.allstar.spring.controller}")
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact("AllStarGH", "https://github.com/AllStarGH/attendance.git", "duernna@163.com");
		return new ApiInfoBuilder().title("员工签到系统端口")// API 标题
